...
try {
	...
	p.println(  ("\tLoan Management System\n"+
			"Reference:\t\t\t"+ATMHBL.refs+
			"\n==============================================\n"+
			"\nIntrest rate:\t\t\t	`"+ATMHBL.k+
			"\nRepayment Year:\t\t\t"+ATMHBL.k1+
			"\nAmount of Loan:\t\t\t"+"$"+ATMHBL.k2+
			"\nMonthly Payment:\t\t\t"+ATMHBL.k3+
			"\nTotal Payment:\t\t\t"+ATMHBL.txtTotal+
			"\n============================================="+
	...
	} catch (IOException e1)
{
	...
	private void initialize() {
		...
		JButton btnl = new JButton("Enter");
		...
		JButton btnd = new JButton("Enter");
...
//				txtT.getText();
//				String txtenter=String.format(txtenter, getText());
//				String txtyear=String.format(txtyear,getText());
//				String txtloan=String.format(txtloan, getText());
//				String txtpay=String.format(txtpay,getText());
//				String txtTotal=String.format(txtTotal,getText());
//				
...
//				"Reference:\t\t\t"+refs+
//				"\n==============================================\n"+
//				"\nIntrest rate:\t\t\t"+txtenter+
//				"\nRepayment Year:\t\t\t"+txtyear+
//				"\nAmount of Loan:\t\t\t"+"$"+txtloan+
//				"\nMonthly Payment:\t\t\t"+txtpay+
//				"\nTotal Payment:\t\t\t"+txtTotal+
//				"\n============================================="+
////				
//				"\n\n\nThankyou\n");
